...
#define CONFIG_EXAMPLE_ENC28J60_MISO_GPIO 17
#define CONFIG_EXAMPLE_ENC28J60_MOSI_GPIO 0
#define CONFIG_EXAMPLE_ENC28J60_SCLK_GPIO 5
#define CONFIG_EXAMPLE_ENC28J60_SPI_CLOCK_MHZ 8
#define CONFIG_EXAMPLE_ENC28J60_CS_GPIO 4
#define CONFIG_EXAMPLE_ENC28J60_INT_GPIO 16
